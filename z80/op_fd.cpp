...
Z80OPCODE opy_22(Z80 *cpu) { // ld (nnnn),iy | M:6 T:20 (4, 4, 3, 3, 3, 3)
...
Z80OPCODE opy_34(Z80 *cpu) { // inc (iy+nn) | M:6 T:23 (4, 4, 3, 5, 4, 3)
...
Z80OPCODE opy_35(Z80 *cpu) { // dec (iy+nn) | M:6 T:23 (4, 4, 3, 5, 4, 3)
   signed char ofs = cpu->MemIf->xm(cpu->pc++);
   unsigned char t = cpu->MemIf->rm(cpu->iy + ofs);
   dec8(cpu, t);
   cpu->MemIf->wm(cpu->iy + ofs, t);
...
Z80OPCODE opy_36(Z80 *cpu) { // ld (iy+nn),nn | M:5 T:19 (4, 4, 3, 5, 3)
   signed char ofs = cpu->MemIf->xm(cpu->pc++);
...
//#endif
//#ifndef Z80_COMMON
Z80OPCODE opy_70(Z80 *cpu) { // ld (iy+nn),b | M:5 T:19 (4, 4, 3, 5, 3)
   signed char ofs = cpu->MemIf->xm(cpu->pc++);
   cpu->MemIf->wm(cpu->iy + ofs, cpu->b);
   cpu->t += 11;
}
Z80OPCODE opy_71(Z80 *cpu) { // ld (iy+nn),c | M:5 T:19 (4, 4, 3, 5, 3)
   signed char ofs = cpu->MemIf->xm(cpu->pc++);
   cpu->MemIf->wm(cpu->iy + ofs, cpu->c);
   cpu->t += 11;
}
Z80OPCODE opy_72(Z80 *cpu) { // ld (iy+nn),d | M:5 T:19 (4, 4, 3, 5, 3)
   signed char ofs = cpu->MemIf->xm(cpu->pc++);
   cpu->MemIf->wm(cpu->iy + ofs, cpu->d);
   cpu->t += 11;
}
Z80OPCODE opy_73(Z80 *cpu) { // ld (iy+nn),e | M:5 T:19 (4, 4, 3, 5, 3)
   signed char ofs = cpu->MemIf->xm(cpu->pc++);
   cpu->MemIf->wm(cpu->iy + ofs, cpu->e);
   cpu->t += 11;
}
Z80OPCODE opy_74(Z80 *cpu) { // ld (iy+nn),h | M:5 T:19 (4, 4, 3, 5, 3)
   signed char ofs = cpu->MemIf->xm(cpu->pc++);
   cpu->MemIf->wm(cpu->iy + ofs, cpu->h);
   cpu->t += 11;
}
Z80OPCODE opy_75(Z80 *cpu) { // ld (iy+nn),l | M:5 T:19 (4, 4, 3, 5, 3)
   signed char ofs = cpu->MemIf->xm(cpu->pc++);
   cpu->MemIf->wm(cpu->iy + ofs, cpu->l);
   cpu->t += 11;
}
Z80OPCODE opy_77(Z80 *cpu) { // ld (iy+nn),a | M:5 T:19 (4, 4, 3, 5, 3)
   signed char ofs = cpu->MemIf->xm(cpu->pc++);
...
Z80OPCODE opy_E3(Z80 *cpu) { // ex (sp),iy | M:6 T:23 (4, 4, 3, 4, 3, 5)
...
Z80OPCODE opy_E5(Z80 *cpu) { // push iy | M:4 T:15 (4, 5, 3, 3) 
